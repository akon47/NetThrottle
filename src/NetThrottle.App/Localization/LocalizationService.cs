...
public sealed class LocalizationService : INotifyPropertyChanged
{
    ...
    private static Dictionary<string, string> BuiltInEnglish() => new(StringComparer.Ordinal)
    {
        ...
        ["Settings.UseMegabytes"] = "Show limits in Mbps",
        ...
        ["Update.ConfirmFormat"] = "A new version {0} is available. Update now?",
        ["Update.PortableConfirmFormat"] = "A new version {0} is available. Open the download page?",
        ["Update.DownloadingStatusFormat"] = "Downloading update {0}…",
